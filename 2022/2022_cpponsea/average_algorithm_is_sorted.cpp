// average_algorithm_is_sorted.cpp
// g++ -std=c++20 average_algorithm_is_sorted.cpp -o prog
#include <iostream>
#include <vector>
...
int main(){
    ...
    if(!std::is_sorted(result_collection.begin(),
             result_collection.end()))
    {
        std::sort(result_collection.begin(),
                  result_collection.end());
    }
