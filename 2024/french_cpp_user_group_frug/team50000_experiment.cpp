// @file team50000_experiment.cpp
// g++ -std=c++23 team50000_experiment.cpp -o prog -lpthread
#include <iostream>
...
int main() {
		...
		std::vector<std::jthread> threads(5000);
		...
		for(int j=0; j < 5'000; j++){
				...
				for(int i=0; i < 4; i++){
						threads.emplace_back(std::jthread(AdditionWorker,i,64));
				} 
		}
