...
/// g++ -std=c++20 polymorphism.cpp -o prog && ./prog 
#include <iostream>
#include <string>
...
int main(){
    ...
    /// IActor is the most 'generic' form of a 'type of' Actor.
    /// So we can allocate a 'MethodActor' or 'ClassicalActor'
    /// The 'virtual calls' will be routed correctly.
    /// This is known as 'dynamic dispatch'
    IActor* s = new MethodActor("Golshifteh Farahani");
    s->Practice();

    delete s;

    s = new ClassicalActor("Golshifteh Farahani");
    s->Practice();
